...
#include "robotROS2FeedbackControlExample_sfun.h"
#include "c1_robotROS2FeedbackControlExample.h"
...
static emlrtRSInfo c1_g_emlrtRSI = { 5,/* lineNo */
  "Conversion",                        /* fcnName */
  "#robotROS2FeedbackControlExample:115"/* pathName */
};
...
static void initialize_c1_robotROS2FeedbackControlExample
  (SFc1_robotROS2FeedbackControlExampleInstanceStruct *chartInstance);
static void initialize_params_c1_robotROS2FeedbackControlExample
  (SFc1_robotROS2FeedbackControlExampleInstanceStruct *chartInstance);
static void mdl_start_c1_robotROS2FeedbackControlExample
  (SFc1_robotROS2FeedbackControlExampleInstanceStruct *chartInstance);
static void mdl_terminate_c1_robotROS2FeedbackControlExample
  (SFc1_robotROS2FeedbackControlExampleInstanceStruct *chartInstance);
static void mdl_setup_runtime_resources_c1_robotROS2FeedbackControlExample
  (SFc1_robotROS2FeedbackControlExampleInstanceStruct *chartInstance);
static void mdl_cleanup_runtime_resources_c1_robotROS2FeedbackControlExample
  (SFc1_robotROS2FeedbackControlExampleInstanceStruct *chartInstance);
static void enable_c1_robotROS2FeedbackControlExample
  (SFc1_robotROS2FeedbackControlExampleInstanceStruct *chartInstance);
static void disable_c1_robotROS2FeedbackControlExample
  (SFc1_robotROS2FeedbackControlExampleInstanceStruct *chartInstance);
static void sf_gateway_c1_robotROS2FeedbackControlExample
  (SFc1_robotROS2FeedbackControlExampleInstanceStruct *chartInstance);
static void ext_mode_exec_c1_robotROS2FeedbackControlExample
  (SFc1_robotROS2FeedbackControlExampleInstanceStruct *chartInstance);
static void c1_update_jit_animation_c1_robotROS2FeedbackControlExample
  (SFc1_robotROS2FeedbackControlExampleInstanceStruct *chartInstance);
static void c1_do_animation_call_c1_robotROS2FeedbackControlExample
  (SFc1_robotROS2FeedbackControlExampleInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_robotROS2FeedbackControlExample
  (SFc1_robotROS2FeedbackControlExampleInstanceStruct *chartInstance);
static void set_sim_state_c1_robotROS2FeedbackControlExample
  (SFc1_robotROS2FeedbackControlExampleInstanceStruct *chartInstance, const
   mxArray *c1_st);
static void initSimStructsc1_robotROS2FeedbackControlExample
  (SFc1_robotROS2FeedbackControlExampleInstanceStruct *chartInstance);
static void initSubchartIOPointersc1_robotROS2FeedbackControlExample
  (SFc1_robotROS2FeedbackControlExampleInstanceStruct *chartInstance);
static real_T c1_sumColumnB(SFc1_robotROS2FeedbackControlExampleInstanceStruct
  *chartInstance, real_T c1_b_x[4]);
static real_T c1_function_handle_parenReference
  (SFc1_robotROS2FeedbackControlExampleInstanceStruct *chartInstance, real_T
   c1_varargin_1, real_T c1_varargin_2);
static void c1_expand_atan2(SFc1_robotROS2FeedbackControlExampleInstanceStruct
...
static void c1_chart_data_browse_helper
  (SFc1_robotROS2FeedbackControlExampleInstanceStruct *chartInstance, int32_T
   c1_ssIdNumber, const mxArray **c1_mxData, uint8_T *c1_isValueTooBig);
static void c1_times(SFc1_robotROS2FeedbackControlExampleInstanceStruct
  ...
  (SFc1_robotROS2FeedbackControlExampleInstanceStruct *chartInstance)
{
  ...
  *chartInstance->c1_yaw = c1_b_yaw;
  c1_do_animation_call_c1_robotROS2FeedbackControlExample(chartInstance);
  ...
  (SFc1_robotROS2FeedbackControlExampleInstanceStruct *chartInstance)
{
  ...
  sf_mex_assign(&c1_d_y, sf_mex_create("y",
    &chartInstance->c1_is_active_c1_robotROS2FeedbackControlExample, 3, 0U, 0U,
    0U, 0), false);
   ...
   mxArray *c1_st)
{
  ...
  *chartInstance->c1_yaw = c1_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c1_is_active_c1_robotROS2FeedbackControlExample =
    c1_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 1)),
    "is_active_c1_robotROS2FeedbackControlExample");
  sf_mex_destroy(&c1_u);
...
const mxArray
  *sf_c1_robotROS2FeedbackControlExample_get_eml_resolved_functions_info()
{
...
/* SFunction Glue Code */
void sf_c1_robotROS2FeedbackControlExample_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_robotROS2FeedbackControlExample_third_party_uses_info(void)
{
...
mxArray *sf_c1_robotROS2FeedbackControlExample_jit_fallback_info(void)
{
...
mxArray *sf_c1_robotROS2FeedbackControlExample_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c1_robotROS2FeedbackControlExample
  (void)
{
  ...
  mxArray *mxVarInfo = sf_mex_decode(
    ...
    "J/AgH366C4H8LPLI5PTC7JLEuNTzaML8pPyi8J8g82cktNTUlKTM52zs8rKcrPca1IzC3ISYXZA"
    "wIAex8g8A=="
    );
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_robotROS2FeedbackControlExample_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c1_robotROS2FeedbackControlExample(void
  *chartInstanceVar)
{
  initialize_params_c1_robotROS2FeedbackControlExample
    ((SFc1_robotROS2FeedbackControlExampleInstanceStruct*) chartInstanceVar);
  initialize_c1_robotROS2FeedbackControlExample
    ((SFc1_robotROS2FeedbackControlExampleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_robotROS2FeedbackControlExample(void
  *chartInstanceVar)
{
  enable_c1_robotROS2FeedbackControlExample
    ((SFc1_robotROS2FeedbackControlExampleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_robotROS2FeedbackControlExample(void
  *chartInstanceVar)
{
  disable_c1_robotROS2FeedbackControlExample
    ((SFc1_robotROS2FeedbackControlExampleInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_robotROS2FeedbackControlExample(void
  *chartInstanceVar)
{
  sf_gateway_c1_robotROS2FeedbackControlExample
    ((SFc1_robotROS2FeedbackControlExampleInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c1_robotROS2FeedbackControlExample
  (SimStruct* S)
{
  return get_sim_state_c1_robotROS2FeedbackControlExample
    ((SFc1_robotROS2FeedbackControlExampleInstanceStruct *)
     sf_get_chart_instance_ptr(S));    /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c1_robotROS2FeedbackControlExample(SimStruct*
  S, const mxArray *st)
{
  set_sim_state_c1_robotROS2FeedbackControlExample
    ((SFc1_robotROS2FeedbackControlExampleInstanceStruct*)
     sf_get_chart_instance_ptr(S), st);
}

static void
  sf_opaque_cleanup_runtime_resources_c1_robotROS2FeedbackControlExample(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_robotROS2FeedbackControlExampleInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_robotROS2FeedbackControlExample_optimization_info();
    }

    mdl_cleanup_runtime_resources_c1_robotROS2FeedbackControlExample
      ((SFc1_robotROS2FeedbackControlExampleInstanceStruct*) chartInstanceVar);
    ((SFc1_robotROS2FeedbackControlExampleInstanceStruct*) chartInstanceVar)->
      ~SFc1_robotROS2FeedbackControlExampleInstanceStruct();
...
static void sf_opaque_mdl_start_c1_robotROS2FeedbackControlExample(void
  *chartInstanceVar)
{
  mdl_start_c1_robotROS2FeedbackControlExample
    ((SFc1_robotROS2FeedbackControlExampleInstanceStruct*) chartInstanceVar);
  if (chartInstanceVar) {
...
static void sf_opaque_mdl_terminate_c1_robotROS2FeedbackControlExample(void
  *chartInstanceVar)
{
  mdl_terminate_c1_robotROS2FeedbackControlExample
    ((SFc1_robotROS2FeedbackControlExampleInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_robotROS2FeedbackControlExample(SimStruct *S)
{
  ...
  if (sf_machine_global_initializer_called()) {
    ...
    initSubchartIOPointersc1_robotROS2FeedbackControlExample
      ((SFc1_robotROS2FeedbackControlExampleInstanceStruct*)
       sf_get_chart_instance_ptr(S));
  }
}

const char* sf_c1_robotROS2FeedbackControlExample_get_post_codegen_info(void)
{
  int i;
  const char* encStrCodegen [21] = {
    "eNrdWMtyG0UUbTnGlVDByQ4WVJFixcJUEQdSLCiwokcikLGIZPPYOK2Zq5ku9XRP+qEH38EH8Av",
    "s+IQs2VDFnmLPMktuj0ayLAtpWgpFkqkaj3umT597b99Xi5QaxwSvfbxb7xCyh8/reO+QyfVGPi",
    "7N3ZP3u+SzfPzsTUICGUIEom17PTYifpewSYsqmmjifwmawGPQklvDpGiIniyOZaIHCkSAC6RSG",
    "S9ezRLLmejXrQgcs/42ZkHcjqXl4QNckIYngo//jTe1poWMVaYgMHWA0MRK2iiucxqttoIyw0oM",
    "QV/bxNtWGkzbpk5VfWy5YSmH2giChtCGohX0Gn3bhhqomJGfkZ2+uj1FyyTljIrito6pbkOK3mH",
    "gNA3x74k1aL2CvMjXZYIaqRjltYRXYqqKYlsc5TxGt+bedjaJqULXRhETkbOusgkI1B/9pICteh",
    "U5AEUjOBF+vIHTrjbKNnjmlwWxhiVwRlU5QD/QEPrFIDqwblPcWujgMl5YELTLoaE7ig1wj3zzR",
    "sOF0kZ5wyYTT9IbYTPe2gB3VW/IWw9EhXKu/bAdmTZhADzjr1JDN8BO+D3AWrOwI9E7XOR6Rr8V",
    "7KmFHFuRImTFvXKwgMqKxNeY8AvAWeLCAEI080z02ULr4shqI5MKhn612SzIdxXbEAZUjwZQOF8",
    "ryjSgwJlfefKGTLtAQjRayWRaFl5hEoMbQYnuWVEdStVHG/sWhgtbuUjwQ0MYQRUMZEmuht59Rr",
    "ktKHOiMSs79zjVmGX9eBHr4mcjcECDGEJXAxmHY8yzuEDRLdaufJZR2wEz4yroQLG0aCRZTOhY/",
    "JyVOuMUTkVfyKGoK5m08y5mhV8BYNagSmApe4ClVI3rKHwxqRU87WTZ3bdhcHamhtOu842HILAa",
    "Ol1d9aYBRlVNYLuJAm2DbbMfsR0RmmmDLeC4lsVAmPXB35GLPnh3SR/8/lwffDsfB3fPlexK8/i",
    "kfegaui4N+ri8UZLXRllpnMx36380t/7NAn12ERy5grvgmz4/mMOXlvCSueci342dy/N3F/h28E",
    "0JL4c7msO9RVbj9nIb3vr51u8fPz8o//XTb189+1P/so6/dIW/lP3vcL/u+J1j9vPxu9MeapaxB",
    "1eSmpv7aI1/vL3gH26sm2fflytRk6cP7/PRl3B4T37Tih5l611fI+/OgrzT93dc34YBneUHFTTC",
    "/DzkxtRO+nS3/qdz8u6tsceNOX8i5O8vtsPfOVrcx2X2unbJXtfImA4v+e22/JvjJ/xP1sh/sLD",
    "fB1kff05dtobzYplhv2DcrfJ7X9yrwve6y/ki9StST3Y3xJX+w/r1InHb6udbJ1/1+avyM1mYf/",
    "sl1mNVHvXpl142vf4gfv3Me/n489nZvRIzHi45PeSfscHvLfv6mvj3c0/7Tfu3mrNf/oPpD/fKg",
    "vIxHhcmx7H8dUu53+pmnxRQvfxM9n/Uk+nzaE3/cnMhvt14yEQoh/rDu4ef3N+mPv0DNpoV3Q==",
    ""
  };
...
static void mdlSetWorkWidths_c1_robotROS2FeedbackControlExample(SimStruct *S)
{
  const char* newstr =
    sf_c1_robotROS2FeedbackControlExample_get_post_codegen_info();
...
static void mdlRTW_c1_robotROS2FeedbackControlExample(SimStruct *S)
{
...
static void mdlSetupRuntimeResources_c1_robotROS2FeedbackControlExample
  (SimStruct *S)
{
  SFc1_robotROS2FeedbackControlExampleInstanceStruct *chartInstance;
  chartInstance = (SFc1_robotROS2FeedbackControlExampleInstanceStruct *)utMalloc
    (sizeof(SFc1_robotROS2FeedbackControlExampleInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_robotROS2FeedbackControlExample;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_robotROS2FeedbackControlExample;
  chartInstance->chartInfo.mdlStart =
    sf_opaque_mdl_start_c1_robotROS2FeedbackControlExample;
  chartInstance->chartInfo.mdlTerminate =
    sf_opaque_mdl_terminate_c1_robotROS2FeedbackControlExample;
  chartInstance->chartInfo.mdlCleanupRuntimeResources =
    sf_opaque_cleanup_runtime_resources_c1_robotROS2FeedbackControlExample;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c1_robotROS2FeedbackControlExample;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_robotROS2FeedbackControlExample;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_robotROS2FeedbackControlExample;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_robotROS2FeedbackControlExample;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_robotROS2FeedbackControlExample;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_robotROS2FeedbackControlExample;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_robotROS2FeedbackControlExample;
  ...
  mdl_setup_runtime_resources_c1_robotROS2FeedbackControlExample(chartInstance);
}

void c1_robotROS2FeedbackControlExample_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_SETUP_RUNTIME_RESOURCES:
    mdlSetupRuntimeResources_c1_robotROS2FeedbackControlExample(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_robotROS2FeedbackControlExample(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_robotROS2FeedbackControlExample(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_robotROS2FeedbackControlExample_method_dispatcher.\n"
